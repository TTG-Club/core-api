...
INSERT INTO ttg.entity_tags (entity_url, tag_key, tag_value) VALUES ('assimar/light-bearer', 'aasimar', 'https::/ttg.club/racial feature');
INSERT INTO ttg.entity_tags (entity_url, tag_key, tag_value) VALUES ('assimar/light-bearer', 'light', 'https::/ttg.club/illumination');
INSERT INTO ttg.entity_tags (entity_url, tag_key, tag_value) VALUES ('assimar/light-bearer', 'magic', 'https::/ttg.club/cantrip');
INSERT INTO ttg.entity_tags (entity_url, tag_key, tag_value) VALUES ('forest-gnome/natural-illusionist', 'gnome', 'https::/ttg.club/racial feature');
INSERT INTO ttg.entity_tags (entity_url, tag_key, tag_value) VALUES ('forest-gnome/natural-illusionist', 'magic', 'https::/ttg.club/illusion');
INSERT INTO ttg.entity_tags (entity_url, tag_key, tag_value) VALUES ('gnome/gnomish-cunning', 'gnome', 'https::/ttg.club/racial feature');
INSERT INTO ttg.entity_tags (entity_url, tag_key, tag_value) VALUES ('gnome/gnomish-cunning', 'magic', 'https::/ttg.club/resistance');
INSERT INTO ttg.entity_tags (entity_url, tag_key, tag_value) VALUES ('rock-gnome/artificer-lore', 'gnome', 'https::/ttg.club/racial feature');
INSERT INTO ttg.entity_tags (entity_url, tag_key, tag_value) VALUES ('rock-gnome/artificer-lore', 'skill', 'https::/ttg.club/lore');
INSERT INTO ttg.entity_tags (entity_url, tag_key, tag_value) VALUES ('rock-gnome/tinker', 'craft', 'https::/ttg.club/mechanics');
INSERT INTO ttg.entity_tags (entity_url, tag_key, tag_value) VALUES ('rock-gnome/tinker', 'gnome', 'https::/ttg.club/racial feature');
