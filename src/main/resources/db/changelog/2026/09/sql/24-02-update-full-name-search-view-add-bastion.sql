...
FROM (
         ...
         UNION ALL
         SELECT bastion_facility.url,
                bastion_facility.name,
                bastion_facility.english,
                bastion_facility.alternative,
                bastion_facility.source_page AS page,
                'BASTION'::text AS type,
                bastion_facility.source,
                bastion_facility.is_hidden_entity,
                bastion_facility.created_at,
                bastion_facility.updated_at
         FROM bastion_facility
