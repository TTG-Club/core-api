...
import club.ttg.dnd5.jooq.tables.records.DatabasechangelogRecord;
...
public class JooqDatabasechangelog extends TableImpl<DatabasechangelogRecord> {
     ...
     */
    public static final JooqDatabasechangelog DATABASECHANGELOG = new JooqDatabasechangelog();
    ...
    private JooqDatabasechangelog(Name alias, Table<DatabasechangelogRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private JooqDatabasechangelog(Name alias, Table<DatabasechangelogRecord> aliased, Field<?>[] parameters, Condition where) {
     ...
     */
    public JooqDatabasechangelog(String alias) {
     ...
     * Create an aliased <code>public.databasechangelog</code> table reference
     */
    public JooqDatabasechangelog(Name alias) {
    ...
    @Override
    public JooqDatabasechangelog as(String alias) {
        return new JooqDatabasechangelog(DSL.name(alias), this);
    }

    @Override
    public JooqDatabasechangelog as(Name alias) {
        return new JooqDatabasechangelog(alias, this);
    }

    @Override
    public JooqDatabasechangelog as(Table<?> alias) {
        return new JooqDatabasechangelog(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public JooqDatabasechangelog rename(String name) {
        return new JooqDatabasechangelog(DSL.name(name), null);
    }
     ...
     */
    @Override
    public JooqDatabasechangelog rename(Name name) {
        return new JooqDatabasechangelog(name, null);
    }
     ...
     */
    @Override
    public JooqDatabasechangelog rename(Table<?> name) {
        return new JooqDatabasechangelog(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public JooqDatabasechangelog where(Condition condition) {
        return new JooqDatabasechangelog(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public JooqDatabasechangelog where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public JooqDatabasechangelog where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public JooqDatabasechangelog where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public JooqDatabasechangelog where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public JooqDatabasechangelog where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public JooqDatabasechangelog where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public JooqDatabasechangelog where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public JooqDatabasechangelog whereExists(Select<?> select) {
     ...
     */
    @Override
    public JooqDatabasechangelog whereNotExists(Select<?> select) {
