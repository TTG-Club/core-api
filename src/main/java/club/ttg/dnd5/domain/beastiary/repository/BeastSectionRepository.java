...
@Repository
public interface BeastSectionRepository extends JpaRepository<BeastSection, String> {
    @Query(value = """
            select b from BeastSection b
    ...
    List<BeastSection> findBySearchLine(String searchLine, String invertedSearchLine, Sort sort);
}
