...
public class CreatureActionEffect {
    ...
    /**
     * Типы урона старых данных. Формой не показываются и в выгрузку не идут:
     * тип урона несёт сама часть урона. Возятся сквозь форму, чтобы круг
     * «открыл — сохранил» не стёр их у записи.
     */
