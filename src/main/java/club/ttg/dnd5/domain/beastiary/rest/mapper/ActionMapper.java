...
public interface ActionMapper {
     ...
     *
     * Зеркало {@link #raiseLegacyMechanics}: из этих полей выгрузка берёт тип
     * атаки и спасбросок у записей, которым механику ещё не завели, и потеряться
     * в круге через форму они не должны.
     *
