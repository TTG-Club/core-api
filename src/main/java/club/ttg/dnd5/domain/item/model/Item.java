...
public class Item extends NamedEntity {
    ...
    /**
     * Для какого оружия этот боеприпас ({@code ItemType.AMMUNITION}). У оружия «чем
     * стреляет» лежит в {@link Weapon#getAmmo()}, а у самого боеприпаса до появления
     * поля не было ничего — и выстрел на листе не находил стрелы своего типа.
     *
     * <p>Пусто — у предметов, которые боеприпасом не являются.</p>
     */
    @Enumerated(EnumType.STRING)
