 ...
 * ({@code calligraphers-supplies}) — это 19 позиций из 40. Во-вторых, ключ, которого в
...
final class VttgToolKeys {
    /**
     * Ключи справочника инструментов листа персонажа: 40 конкретных плюс обобщённая
     * группа «на выбор», которую лист принимает наравне с конкретными.
     */
    private static final Set<String> KEYS = Set.of(
            ...
            // Музыкальные инструменты. Три последних — фаэрунские (FRHoF), они есть в пуле
            // «музыкальный инструмент» у предысторий и у черты «Музыкант»
            "bagpipes", "drum", "dulcimer", "flute", "lute", "lyre", "horn", "pan-flute",
            "shawm", "viol", "bandore", "cittern", "yarting",
            // Прочие
