...
public class VttgFeat {
     ...
     * модификаторы, заклинания, требования). Требование лежит внутри целиком: разобранные
     * поля рядом с человекочитаемой строкой ({@code prerequisite.text}). Отдельной строкой
     * записи оно не едет — в описании черты его нет, это разные колонки.
     */
    private VttgFeatData featData;
    /**
     * Механика влияния черты на лист персонажа: повышение характеристик, владения,
     * постоянные модификаторы и выборы при взятии.
     */
