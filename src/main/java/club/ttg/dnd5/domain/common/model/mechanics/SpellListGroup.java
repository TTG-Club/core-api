...
public class SpellListGroup {
     ...
     * {@code @prof}, {@code @level}, {@code @classLevel} (уровень в своём классе) и
     * {@code @mod.<abbr>}, где {@code abbr} — одно из
     ...
     */
    @Schema(description = "Сколько заклинаний берут: число либо выражение с @prof, @level,"
            + " @classLevel, @mod.<abbr>; пусто — весь список", example = "@prof")
