...
3. [TelegramPublisher](../src/main/java/club/ttg/dnd5/domain/article/service/TelegramPublisher.java)
   ...
   в канале ничего не видно. Если Telegram отклонил пост с карточкой, в фоллбэк-сообщение без превью
   пишутся заголовок и ссылка «Читать на сайте» — иначе пост оказался бы пустым.
